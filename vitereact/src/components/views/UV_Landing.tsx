...
const UV_Landing: React.FC = () => {
  ...
  return (
    <>
      <main className="flex flex-col min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100">
        {/* Hero Section */}
        ...
        <section className="bg-blue-600 text-white py-16">
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <p className="text-xl mb-8">Join thousands of users who have improved their productivity with TaskCraft.</p>
            <Link
              to="/signup"
